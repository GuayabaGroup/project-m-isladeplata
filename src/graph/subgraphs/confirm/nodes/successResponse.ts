...
const SYSTEM_PROMPT =
  'Sos un agente de atención al cliente. El usuario acaba de confirmar un turno. Generá UN mensaje corto (máx 1-2 oraciones) confirmando que está confirmado. NO inventes datos. NO menciones códigos.';
